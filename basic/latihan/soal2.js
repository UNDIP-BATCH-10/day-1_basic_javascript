...
let jawabanFirstWord = first.charAt(0) + "." + first.charAt(5);
let jawabanSecondWord = second.charAt(0) + "." + second.charAt(6);
let jawabanThirdWord = third.charAt(0) + "." + third.charAt(7);
